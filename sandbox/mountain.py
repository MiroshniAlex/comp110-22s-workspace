...
def main():
    ...
    colormode(255)
    screen_color(boris)
    mountain(boris, -200, -150, 10)
    mountain(boris, 0, -150, 10)
    mountain(boris, -360, -150, 10)
    mountain(boris, -300, -150, 10)
    mountain(boris, 100, -150, 10)
    grass(boris, -150)
    update()
    done()
...
def up_slope(turtle, min_length, max_length, num_ridges):
    for i in range(0, num_ridges):
        ...
        turtle.setheading(randint(-10, 30 + i * 6))
